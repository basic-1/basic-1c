...
mkdir -p -m 775 $tmp_dir$proj_dir_name/usr/share/doc/$proj_dir_name/a1rv32
...
cp ../../bin/lnx/$platform/$compiler/rel/a1rv32 $tmp_dir$proj_dir_name/usr/bin
...
cp -af ../../a1rv32/docs $tmp_dir$proj_dir_name/usr/share/doc/$proj_dir_name/a1rv32
...
strip --strip-all $tmp_dir$proj_dir_name/usr/bin/a1rv32
